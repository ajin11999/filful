...
void main() {
  ...
  test('Generate Invoice & Surat Jalan with price changes and partial quantities', () async {
    final po = PurchaseOrdersTableData(
      id: 'po-2',
    ...
    final batch = FulfillmentBatchesTableData(
      id: 'batch-2',
      poId: 'po-2',
      batchNumber: 'SJ-046/01',
      fulfillmentDate: DateTime.now(),
      status: 'in_progress',
      createdAt: DateTime.now(),
    );

    final poItem = PurchaseOrderItemsTableData(
      id: 'item-2',
      poId: 'po-2',
      itemIndex: 1,
      ...
      requestedQty: 50.0,
      uom: 'Kg',
      targetUnitPrice: 40000,
      targetTotalPrice: 2000000,
    );

    // Modified price (42000 vs 40000) and partial qty (30 vs 50)
    final fItem = FulfillmentItemsTableData(
      id: 'f-2',
      batchId: 'batch-2',
      poItemId: 'item-2',
      fulfilledQty: 30.0,
      billedUnitPrice: 42000,
      finalTotalPrice: 1260000,
      status: 'partial',
      note: 'Penyesuaian stok pasar',
    );

    final items = [
      FulfillmentItemWithPoItem(fulfillmentItem: fItem, poItem: poItem),
    ];
